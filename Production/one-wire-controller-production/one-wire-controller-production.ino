// Production code for the SIMB3 one-wire controll board.
// Code responds to requests for data from the SIMB3 mainboard

// Hardware: an SIMB3 one-wire control board with a Adafruit Feather M0 Express
// NOTE: board needs a resistor soldered to the ROM search jumper to ground the pin when not pulled HIGH. Without the resistor the pin is floating. 

// Written 22 January, 2023 by Cameron Planck
