// test code for the bit packing algorithm for the SIMB3 one-wire temperature string
...
// NOTE: this code heavily references the map in the BitPacking.xlsx document. It will be hard to understand without it. 
