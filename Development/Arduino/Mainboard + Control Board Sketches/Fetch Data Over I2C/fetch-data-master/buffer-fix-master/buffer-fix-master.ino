...
// Code communicates with the One-Wire controller asking it for temperature string and air temperature data
// Data is then fetched over I2C in 32 byte chunks, assembled into an arrays, packed, converted, and printed to the console
// This code works in conjunction with buffer-fix-slave.ino
