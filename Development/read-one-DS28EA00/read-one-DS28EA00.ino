// this development sketch is for testing communication between ONE DS28EA00 temperature chip and Arduino.
// raw binary is read off the DS28EA00, bit shifted, and manually converted to a temperature value. 
// the purpose is to validate binary handling for use with the SIMB3 one-wire temperature string control board, which will stream
// raw binary data to the SIMB3 main board.
 
// the hardware configuration is just an Arduino Feather m0 with a single DS28EA00 powered with data flowing through pin 12. 
