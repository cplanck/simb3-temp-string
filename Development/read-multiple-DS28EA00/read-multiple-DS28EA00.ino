// this development sketch is for testing communication between MULTIPLE DS28EA00 temperature chips and Arduino.
// raw binary is read off the DS28EA00s, bit shifted, and manually converted to temperature values. 
